...
import cv1 from '../../assets/img/manicv.jpg';
import cv2 from '../../assets/img/manicv.jpg';
import cv3 from '../../assets/img/manicv.jpg';
import cv4 from '../../assets/img/manicv.jpg';
          ...
          <div className="clc_container">
            ...
            <h1 className="clc_header">About</h1>
              ...
              <div className="AboutBtnContainer">
                <div className="left"><FontAwesomeIcon onClick={() => this.setState({ isOpen: true })} icon={faDiagnoses} className="left_icon" /><br/><br/>Experiences</div>
